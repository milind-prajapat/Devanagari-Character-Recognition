...
callbacks = [ReduceLROnPlateau(monitor = 'val_loss', factor = 0.1,
             ...
             EarlyStopping(patience = 9, # Patience should be larger than the one in ReduceLROnPlateau
                          min_delta = 1e-5),
             CSVLogger(r"Model_1/training.log", append = True),
             ModelCheckpoint(r'Model_1/backup_last_model.hdf5'),
             ModelCheckpoint(r'Model_1/best_val_acc.hdf5', monitor = 'val_accuracy', mode = 'max', save_best_only = True),
             ModelCheckpoint(r'Model_1/best_val_loss.hdf5', monitor = 'val_loss', mode = 'min', save_best_only = True)]

model.fit(trainGenerator, epochs = 50, validation_data = validationGenerator, callbacks = callbacks)

model = load_model(r'Model_1/best_val_loss.hdf5')
